...
Este diretório contém as correções globais para os skills `skill-deploy` e `skill-versioning`, além do script para sincronizá-las com `~/.codex/skills`.

## Script de sincronização

Arquivo: `scripts/sync_codex_global_skills.py`
